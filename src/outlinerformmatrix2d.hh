...
#define outlinerform_mainform_empty      0
#define outlinerform_mainform_tunnel     1
#define outlinerform_mainform_exit       2
#define outlinerform_mainform_complex    3
#define outlinerform_extraform_stalac  0x4
