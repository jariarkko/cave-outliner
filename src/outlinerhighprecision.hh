...
public:
  ...
  HighPrecisionVector2D(outlinerhighprecisionreal xIn,
                        outlinerhighprecisionreal yIn) : x(xIn), y(yIn) {}
};
...
public:
  ...
  HighPrecisionVector3D(outlinerhighprecisionreal xIn,
                        outlinerhighprecisionreal yIn,
                        outlinerhighprecisionreal zIn) : x(xIn), y(yIn), z(zIn) {}
};
